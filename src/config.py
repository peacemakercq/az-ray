...
class Config:
    ...
    def __init__(self):
        ...
        self.azure_client_secret = self._get_env_required("AZURE_CLIENT_SECRET")
    ...
    def v2ray_config_url(self) -> str:
        ...
        return f"https://{self.storage_account_name}.file.core.windows.net/{self.storage_file_share_name}/{self.storage_file_name}"
