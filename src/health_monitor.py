...
class HealthMonitor:
    ...
    def __init__(self, config: Config, azure_manager: AzureManager, v2ray_manager: V2RayManager):
        self.config = config
    ...
    async def _perform_health_check(self):
        ...
        if connection_ok:
            ...
            logger.warning(f"健康检查失败 (连续失败: {self.consecutive_failures}/{self.max_failures})")
